...
echo -ne "Escriba un host objetivo: " && read valor1 # Entrada Host
echo -ne "Ahora, introduzca un PROXY: PORT: " && read svar # Entrada proxy
...
echo -ne "Selecione el Metodo de Solicitud: " && read valor3 #Metodo Requisicao
echo -e "[1] realData
[2] netData
[3] raw"
echo -ne "Seleccione el metodo de conexion: " && read valor4 #Metodo Conexao
case $valor3 in
    1)req="GET";;
    2)req="CONNECT";;
    3)req="PUT";;
...
echo -e "Paloads Generados ... Probando..."
barra="\033[1;36m====================================================================================="
echo -e "$barra"
while read payload; do
#echo -e "\033[1;31mTestando Payload:\033[1;33m$payload"
echo -e "\033[1;31mPAYLOAD EN EL INYECTOR:\n $payload\n"

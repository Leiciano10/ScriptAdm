...
valor2="127.0.0.1"
echo -e "${cor[1]} $bar ${cor[0]}"
echo -e "${cor[5]} Solicitud de metodo ${cor[3]}"
cat <<EOF
...
echo -e "${cor[1]} $bar ${cor[0]}"
read -p " Escriba el Proxy / Dropbear: " hostprox
read -p " Introduzca el puerto: " portx
echo -e "${cor[1]} $bar ${cor[0]}"
echo -e "${cor[1]} ARRANQUE... ${cor[0]}"
echo -e "${cor[1]} $bar ${cor[0]}"
}
while true; do
echo -e " [1]-Prueba un Payload"
echo -e " [2]-Probar Payloads Registradas"
echo -e "${cor[1]} $bar ${cor[0]}"
read -p " [1-2]: " opx
case $opx in
1)
read -p " Introduzca Payload: " payloadx
...
read -p " Escriba el Proxy / o Dropbear: " hostprox
read -p " Introduzca el puerto: " portx
echo -e "${cor[1]} $bar ${cor[0]}"
break
;;
...
read -p " Introduzca el tiempo de espera! (Segundos): " VARS
echo -e "${cor[1]} $bar ${cor[0]}\n"
